    ...
    namespace flowctl{namespace interactive
{
    ...
    public:
        typedef boost::signals2::signal<
            void (boost::system::error_code, std::size_t size)
        > ErrorSignal;
        typedef ErrorSignal::slot_type ErrorSlot;
        typedef ErrorSignal::extended_slot_type ErrorExtendedSlot;
            ...
            const std::size_t readLimitBytes):
                detail::StrandInject<BufferedWrapper>(
                    ...
                    strand_.wrap(boost::bind(
                        &BaseInterface::handle_source_read,
                        this,
                        boost::asio::placeholders::error,
                        boost::asio::placeholders::bytes_transferred
                    )),
                    strand_.wrap(boost::bind(
                        &BaseInterface::handle_source_write,
                        this,
                        boost::asio::placeholders::error,
                        boost::asio::placeholders::bytes_transferred
                    )),
                    strand_.wrap(boost::bind(
                        &BaseInterface::handle_sink_read,
                        this,
                        boost::asio::placeholders::error,
                        boost::asio::placeholders::bytes_transferred
                    )),
                    strand_.wrap(boost::bind(
                        &BaseInterface::handle_sink_write,
                        this,
                        boost::asio::placeholders::error,
                        boost::asio::placeholders::bytes_transferred
                    ))
